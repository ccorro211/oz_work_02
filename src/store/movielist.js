const movie = {
    ...
    "results": [
        ...
        },
        {
            ...
            "overview": "고질라 탄생 70주년 기념 작품. 시리즈 사상 최악의 절망이 일본을 습격한다!  전후, 제로가 된 일본을 뒤쫓듯 나타난 고질라가 이 나라를 마이너스로 떨어뜨린다.  사상 최고로 절망적인 상황 속에서의 습격에 누가? 그리고 어떻게?  일본은 맞서게 되는 것인가...",
            "popularity": 1133.298,
        ...
        },
        {
            ...
            "overview": "문명 붕괴 45년 후, 황폐해진 세상에 무참히 던져진 '퓨리오사'가 고향으로 돌아가기 위해 자신의 인생 전부를 걸고 떠나는 거대한 여정을 그린 액션 블록버스터",
            "popularity": 794.804,
        ...
        },
        {
            ...
            "overview": "브루클린에 사는 한 가족과 우주에서 온 거대 거미와의 싸움을 그린 공포 영화. 주인공 샬롯은 우주에서 온 거미를 우연히 발견하고 스팅이라는 이름을 지어주고 반려동물로 키우기 시작한다. 하지만 이 거미는 점점 더 거대한 괴물로 변하여 샬롯의 아파트 단지를 공포에 빠뜨리는데...",
            "popularity": 716.554,
        ...
        },
        {
            ...
            "overview": "무더운 여름의 뉴욕의 어느 날, 고대 유물 속 깨어난 데스칠로 인해 정체불명의 냉기가 몰려오고 마침내 도시는 얼어붙고 만다. 유령을 퇴치하는 그루버슨과 라이즈 버스터즈 멤버들은 얼어붙은 세상을 깨부수기 위해 유령 군단을 쫓기 시작하는데…",
            "popularity": 628.946,
        ...
        },
        {
            ...
            "overview": "NASA는 거대 유인원 아브라함을 모델로 힘과 규모에서 아브라함에 버금가는 기계 유인원을 설계한다. 하지만 첫 번째 실험 결과가 좋지 않게 나오자 미 국방성에서는 난폭한 기계 유인원을 막기 위해 감옥에 갇힌 아브라함을 석방하도록 지시한다. 한편 볼로드레츠카 외국 정보부는 기계 유인원에 핵탄두를 부착해 기계 유인원의 시스템을 교란시켜 미국 시카고를 날려버릴 계략을 꾸민다. 이를 막기 위해 NASA의 관계자들은 아브라함과 소통하는 방법을 통해 기계 유인원을 막으려 하는데....",
            "popularity": 704.388,
        ...
        },
        {
            ...
            "overview": "전직 군의관이 근무하는 병원을  아일랜드 마피아가 장악하면서 생존을 위한 치명적인 전투에 휘말리게 됩니다.  아들이 인질로 잡히자, 그녀는 자신 외에는 구해줄 사람이 없다는 것을 깨닫고 전투로 단련된 과거와 치명적인 기술에 의존해야만 합니다.",
            "popularity": 638.358,
        ...
        },
        {
            ...
            "overview": "멕시코 휴양지로 가는 비행기  하지만 비행기의 엔진 문제로 사고가 발생하고 깊은 바닷속으로 추락한다.  주지사의 딸 ‘에이바’와 경호원 ‘브랜드’, 남자친구 ‘제드’, ‘카일’ 그리고 어린 소녀 ‘로자’와 할머니, 승무원 ‘다닐로’까지 단 7명만이 살아남지만 비행기 에어포켓 안 공기가 떨어지면서 점점 깊이 가라앉는다  생존 시간은 턱 끝까지 차오르고 상어 떼마저 이들을 위협하는데…",
            "popularity": 632.084,
        ...
        },
        {
            ...
            "overview": "제2차 세계대전 당시 핵무기 개발을 위해 진행되었던 비밀 프로젝트 ‘맨해튼 프로젝트’를 주도한 미국의 물리학자 ‘로버트 오펜하이머’의 이야기",
            "popularity": 602.85,
